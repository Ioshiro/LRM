...
--local items2 = {}
--items2["name1"] = { "item1", "item2" }
--items2["name2"] = { "item2", "item3" }
--items2["name3"] = { "item3", "item4" }
--items2["name4"] = { "item4", "item5" }
--items2["name5"] = { "item5", "item6" }
--items2["name6"] = { "item6", "item7" }
--items2["name7"] = { "item7", "item8" }
--items2["name8"] = { "item8", "item9" }
--items2["name9"] = { "item9", "item10" }
--items2["name10"] = { "item10", "item11" }
--items2["name11"] = { "item11", "item12" }
--items2["name12"] = { "item12", "item13" }
--items2["name13"] = { "item13", "item1" }
...
--local function performSell(button, args)
--    if not args["isOK"] then
--        sellWindow:close()
--    end
--    tempText = sellWindow["e1"]:getValue()
--    getPlayer():Say(tempText)
--
--end

--function showSellWindow(item)
--    if sellWindow then
--        sellWindow:close()
--    end
--
--    sellWindow = NewUI()
--    sellWindow:addText("", "Entry:", _, "Center")
--    sellWindow:addEntry("e1", "")
--    sellWindow["e1"]:setValue(tempText)
--    sellWindow["e1"]:setMarginHorizontal(10)
--    sellWindow:nextLine()
--
--    sellWindow:addButton("btnCancel", "Cancel", performSell)
--    sellWindow["btnCancel"]:addArg("isOK", false)
--    sellWindow:addButton("btnSubmit", "Submit", performSell)
--    sellWindow["btnSubmit"]:addArg("isOK", true)
--    sellWindow:saveLayout()
--
--end
--<H1> Your a policeman ! <LINE> <SIZE:small> You are here to protect people ! <LINE> <SIZE:small> <LEFT> You can: <LINE> - Do that <LINE> - And that <LINE> - And a lot more
--local function createGoodText()
--    return ""
--end
...
function openGoodEditWindow(items)
    ...
    --detailUI["GoodsDesc"]:setEnterFunc(function(_, _)
    --    detailUI["GoodsDesc"]:setValue(detailUI["GoodsDesc"]:getValue() + " <LINE> ")
    --end)
    detailUI:nextLine()
    ...
    --
    --        for j = 1, #items[i].items - 1 do
    --
    --            table.insert(temp, items[i].items[j])
    --            table.insert(itemList, items[i].items[j]:getDisplayName())
    --        end
    --    else
    --        table.insert(temp, items[i])
    --        table.insert(itemList, items[i]:getDisplayName())
    --    end
    --end
    ...
    --detailUI:setBorderToAllElements(true)                        -- Add border
    detailUI:saveLayout()
...
function openGoodDetailWindow(UI, items)
    ...
    --goodsDetailUI:nextLine()
    --addLine(goodsDetailUI)
    --goodsDetailUI:addText("GoodsPriceValue", tostring(math.floor(goodsInfo.price * 100)).."$", "Medium", "Right")
...
function openPlayerTradeMainUI(pId)
    ...
    --playerTradeMainUI["Category"]:setOnChange(openList2)
